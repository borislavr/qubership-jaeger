...
{{- define "jaeger-integration-tests.image" -}}
  ...
  {{- else -}}
    {{- print "ghcr.io/netcracker/jaeger-integration-tests:1.0.4" -}}
  {{- end -}}
{{- end -}}
...
{{- define "readiness-probe.image" -}}
  ...
  {{- else -}}
    {{- print "ghcr.io/netcracker/jaeger-readiness-probe:1.0.4" -}}
  {{- end -}}
{{- end -}}
...
{{- define "spark-dependencies.image" -}}
  ...
  {{- else -}}
    {{- print "ghcr.io/jaegertracing/spark-dependencies/spark-dependencies:v0.5.2" -}}
  {{- end -}}
{{- end -}}
